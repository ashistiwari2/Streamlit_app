...
def dataframe(data):
    ...
    df.to_excel('prediction_data.xlsx', index=False)
    st.dataframe(df)
...
def main():
    ...
    'logistic_regression', 'random_forest', 'KNN', 'XGBclassifier', 'Linear discrimant analysis', 'decision_tree'))
            ...
            if submit_text:
                ...
                with st.spinner(f'Predicting with given data:{a}.....'):
                    ...
                    with col2:
                        ...
                        st.subheader(
                            "Acuuracy score:{}\nf1_score:{}\nRecall_score:{}\nPrecision_score:{}".format(score, f_score,
                                                                                                         recall,
                                                                                                         precision))
                        st.write("\n summary:\n{}".format(summary))
                        st.write("\nconfusion matrix:\n{}".format(confusion))
